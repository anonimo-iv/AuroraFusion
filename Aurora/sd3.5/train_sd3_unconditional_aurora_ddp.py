...
def main():
    ...
    if args.resume_from_checkpoint:
        ...
        training_state = load_checkpoint(transformer, optimizer, lr_scheduler, checkpoint_path)
        if training_state:
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if global_step % args.checkpointing_steps == 0 and global_step > 0:
                    save_checkpoint(transformer, optimizer, lr_scheduler, global_step, epoch, args, best_val_loss)
